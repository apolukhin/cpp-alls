...
tcp_connection::tcp_connection(std::shared_ptr<api::io_service_provider>&& io_service)
...
std::shared_ptr<tcp_connection> tcp_connection::create(std::shared_ptr<api::io_service_provider> io_serv) {
